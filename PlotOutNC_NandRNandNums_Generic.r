...
year0<-2013   # or whatever is appropriate. 
fishingStartYear<-1950  #All this does is draw a red vertical line on the plots. 
...
setwd('C:/Users/isaac.kaplan/Documents/Atlantis/CalCurrentAtlantisV3/RPlottingNCfile') # set working directory, place with  CSV file (see below)

pathToSavePlots <- "C:/Users/isaac.kaplan/Documents/Atlantis/CalCurrentAtlantisV3/RPlottingNCfile/"
...
{ 
   ...
   par(mfrow=c(plotRowsPerPage,plotColsPerPage)) # lay out the 3x2 blank plots
     ...
     if (!is.na(FuncGroupNamesInPlotOrder$NetCDFName[funcGroup]))  
     {
        ...
        plot(simYears,thisY,lwd=3,type='l',cex.lab=1.1,cex.axis=1.2, col='black',lty='dashed',ylab=yLabString,main=FuncGroupNamesInPlotOrder$commonName[funcGroup],xlab='Year',ylim=c(0,maxYForPlot ),cex.main=1.3)
        if (wantSubtitle)
        {
